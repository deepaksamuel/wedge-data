...
B1DetectorConstruction::B1DetectorConstruction(float top_width, float bottom_width)
...
{  
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 5*cm, env_sizeZ = 35*cm;
  ...
  G4LogicalVolume* logicWedge =
    new G4LogicalVolume(wedge,            //its solid
